...
$(window).load(function() {
    ...
    $('#btnSave').click(function(){
        if(cbk128.checked == true){
          ...
          file_url_net = "../"+dataset_name+"/"+ dataset_name +"_CNN-128F_network.json";
          file_url_info = "../"+dataset_name+"/"+ dataset_name +"_CNN-128F_Information.txt";
          $('#myModal').modal('hide');
          waitingDialog.show("Loading pretrained network - CNN-128F");
...
var getimage = function(){
  ...
  img_preview_hide.setAttribute("style","width:"+image_dimension_w+"px");
  img_preview_hide.setAttribute("style","height:"+image_dimension_h+"px");
