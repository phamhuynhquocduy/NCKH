...
var max_acc = parseFloat(70).toFixed(4);
...
var toggle_start = function () {
  ...
  start_time = GetTimeString(d_start); //lấy thời gian bắt đầu huấn luyện
  start_fun();
}
...
//-------------------------------------Xử lý lưu thông tin khi max acc-------------------------------------------
//Time max acc
